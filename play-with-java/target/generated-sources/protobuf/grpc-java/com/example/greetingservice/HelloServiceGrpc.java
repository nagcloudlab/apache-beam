...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.greetingservice.HelloRequest,
      com.example.greetingservice.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.greetingservice.HelloRequest.class,
      responseType = com.example.greetingservice.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.greetingservice.HelloRequest,
      com.example.greetingservice.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.greetingservice.HelloRequest, com.example.greetingservice.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.greetingservice.HelloRequest, com.example.greetingservice.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.greetingservice.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.greetingservice.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.example.greetingservice.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.greetingservice.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void sayHello(com.example.greetingservice.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.greetingservice.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingV2Stub
    ...
    /**
     */
    public com.example.greetingservice.HelloResponse sayHello(com.example.greetingservice.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.greetingservice.HelloResponse> sayHello(
        com.example.greetingservice.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.greetingservice.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.greetingservice.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.greetingservice.HelloRequest,
              com.example.greetingservice.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.greetingservice.HelloProto.getDescriptor();
    }
